...
const mainBody = {
  ...
  icons: [
    ...
    {
      image: "fa-twitter",
      url: "https://www.twitter.com/six_degree_lab",
    },
  ],
};
...
const about = {
  ...
  imageSize: 375,
  message:
    "We are a group of blockchain enthusiasts. We hope that by analyzing the data on the chain, we can tap the potential value behind the data, and provide it to the majority of web3 users and related projects to help them better invest or operate projects. If you have project requirements for data analysis, please contact us by email, twitter, etc.",
  resume: "",
};
